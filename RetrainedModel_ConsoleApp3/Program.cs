using RetrainedModel_ConsoleApp3;
using System.IO;
...
class program
{
    static void Main()
    {
        ...
        string folderPath = @"D:\Skrivebord\Ny Data\Machinelerning hjemme data\Machinelearning data\Ny mappe (2) - Kopi";
        ...
        foreach (string imagePath in imageFilePaths)
        {
            ...
            string filepath = Path.Combine(@"D:\Skrivebord\Ny Data\Machinelerning hjemme data\Machinelearning data\Named Files", sortedScoresWithLabel.PredictedLabel + ".png");
